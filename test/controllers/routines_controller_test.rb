...
class RoutinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create routine" do
    assert_difference('Routine.count') do
      post routines_url, params: { routine: { description: @routine.description, end_date: @routine.end_date, name: @routine.name, start_date: @routine.start_date, trainee_id: @routine.trainee_id } }
    end
  ...
  test "should update routine" do
    patch routine_url(@routine), params: { routine: { description: @routine.description, end_date: @routine.end_date, name: @routine.name, start_date: @routine.start_date, trainee_id: @routine.trainee_id } }
