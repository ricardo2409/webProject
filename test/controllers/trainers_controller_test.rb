...
class TrainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post trainers_url, params: { trainer: { last_name: @trainer.last_name, name: @trainer.name } }
    end
  ...
  test "should update trainer" do
    patch trainer_url(@trainer), params: { trainer: { last_name: @trainer.last_name, name: @trainer.name } }
